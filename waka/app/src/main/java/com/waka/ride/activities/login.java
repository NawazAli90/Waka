...
import com.waka.ride.Common.repo.LoginRepository;
import com.waka.ride.Core.network.constant.response.*;
...
public class login extends AppCompatActivity {
    OnLoginApiResponse listener = new OnLoginApiResponse() {
        @Override
    ...
    private void validateFields() {
       ...
       /* binding.progressBar.setVisibility(View.VISIBLE);
        ...
        loginRepository.getLogin(email, password, listener);
