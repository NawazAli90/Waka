...
import com.shahjahan.kiwiuser.databinding.ActivityScanQRBinding;
import com.shahjahan.kiwiuser.models.AttendanceResponse;
...
public class scanQRActivity extends AppCompatActivity implements BarcodeReader.BarcodeReaderListener {
    ...
    public void onScanned(Barcode barcode) {
        ...
        api.attendanceResponse(sharedPref.getUser_id(),s).enqueue(new apiResponse());
    }
